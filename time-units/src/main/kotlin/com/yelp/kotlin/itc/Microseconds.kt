...
class Microseconds internal constructor(nanos: Long) : Duration(nanos) {
    override operator fun plus(other: Duration) = Microseconds(nanos + other.nanos)
    override operator fun minus(other: Duration) = Microseconds(nanos - other.nanos)
}

val Duration.asMicros: Microseconds get() = Microseconds(nanos)
